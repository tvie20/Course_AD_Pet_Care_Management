...
import { Calendar as CalendarIcon, Save, Camera, ShieldCheck, Pencil, X, Stethoscope, Award, Briefcase } from "lucide-react"
...
export default function DoctorProfilePage() {
  // Giả lập dữ liệu ban đầu từ DB (Join NHANVIEN & BACSITHUY)
  const [formData, setFormData] = useState({
    MaNV: "NV001",
    HoTenNV: "Nguyễn Văn A",
    NgaySinhNV: new Date(1990, 5, 15),
    GioiTinhNV: "Nam",
    LoaiNV: "Bác sĩ thú y", // Mặc định hiển thị, không sửa
    ChungChiHanhNghe: "CCHN-2023-00123",
    ChuyenKhoa: "Nội khoa",
    SoNamKinhNghiem: 5,
  ...
  const handleSave = (e: React.FormEvent) => {
    e.preventDefault()
    // Logic gọi API update thông tin bác sĩ ở đây
    console.log("Saving doctor data:", formData)
    setIsEditing(false)
  }

  const handleCancel = () => {
    // Reset lại dữ liệu (trong thực tế sẽ fetch lại từ API hoặc dùng state backup)
    setIsEditing(false)
  }
